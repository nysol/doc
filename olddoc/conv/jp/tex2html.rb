...
if ARGV.size != 5 and ARGV.size != 6 then
	...
	STDERR.puts "#{$0} xxmcmd ../../mcmd/jp mcmd.tex mcmd_jp.sty MCMD"
	STDERR.puts "#{$0} xxtutorial ../../tutorial/mcmd/jp tutorial.tex tutorial.sty MCMD_TUTORIAL"
	STDERR.puts "#{$0} xxzdd ../../zdd/jp zdd.tex zdd.sty ZDD"
